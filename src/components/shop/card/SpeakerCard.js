...
const SpeakerCard = () => {
  ...
  const { speaker } = useSelector((state) => state.SpeakerReducer);
  useEffect(() => {
      ...
      <div className="Product_main">
        <div className="Product_image">
          <div className="Product_main_image">
            <img
              src={require("../../../IMAGES/cell-big.webp")}
              alt="placeholder"
            />
          </div>
